...
module.exports = function(dgmApiGroup) {
	...
	dgmApiGroup.addroute('/effects', function(req, db, apiMasks, responseFn) {

		var queryParams = {
			fields: apiMasks.effectMask.getFields(req.query.params)
		};

		db.dgm.getAllEffects(queryParams, responseFn);
	});
};
