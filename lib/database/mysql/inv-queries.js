...
module.exports = function(setupQuery) {
	...
	var getTypeAutocomplete = setupQuery("SELECT ?? FROM invTypes WHERE typeName LIKE ? ORDER BY typeName LIMIT 20", ['fields', 'phrase']);
	...
	return {
		...
		getMetaGroups: getMetaGroups,
		getTypeAutocomplete: getTypeAutocomplete,
	};
};