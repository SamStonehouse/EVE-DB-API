...
module.exports = function(setupQuery) {
	...
	queries.getTypeEffectsByTypeID = setupQuery("SELECT * FROM dgmTypeEffects LEFT JOIN dgmEffects ON dgmTypeEffects.effectID = dgmEffects.effectID WHERE dgmTypeEffects.typeID = ?", ['typeID']);
