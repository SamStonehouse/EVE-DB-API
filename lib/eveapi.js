...
var setupRoutes = function(app) {
	...
	certApi.setupRoutes(app, apiUtils.apiResponse);
	chrApi.setupRoutes(app, apiUtils.apiResponse);
	crpApi.setupRoutes(app, apiUtils.apiResponse);
...
module.exports = function(_db) {
	...
	certApi = certApi(db.cert, apiUtils.maskInterpreter);
	chrApi = chrApi(db.chr, apiUtils.maskInterpreter);
	crpApi = crpApi(db.crp, apiUtils.maskInterpreter);
