...
module.exports = function(invApiGroup, apiUtilities) {
	...
	invApiGroup.addroute('/types/marketgroup/:marketGroupID', function(req, db, apiMasks, responseFn) {
		...
		db.inv.getTypesInMarketGroup(queryParams, responseFn);
	});
	...
	invApiGroup.addroute('/metagroups', function(req, db, apiMasks, responseFn){

		var queryParams = {
			fields: apiMasks.metaGroupMask.getFields(req.query.fields)
		};

		db.inv.getMetaGroups(queryParams, responseFn);
	});
};
